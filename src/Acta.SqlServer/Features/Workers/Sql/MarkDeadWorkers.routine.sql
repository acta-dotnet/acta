...
BEGIN
    ...
    SELECT 122 /* JobEventCode.WorkerDead */, SYSUTCDATETIME(), m.namespace_id, 70 /* JobActorCode.Worker */, CAST(m.id AS VARCHAR(128)),
           NULL, NULL, NULL, NULL, m.id, NULL, NULL, NULL, NULL, 101 /* JobEventReasonCode.WorkerHeartbeatStale */, NULL
      FROM @marked m;
