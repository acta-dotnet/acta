...
UPDATE {{schema}}.steps
   SET status_code      = CASE WHEN @p_at_most_once THEN 230 /* JobStepStatusCode.Interrupted */ ELSE status_code END,
...
SELECT @p_job_id, @p_name, 10 /* JobStepStatusCode.Pending */, 1,
...
SELECT
    ...
    CASE WHEN a.status_code = 100 /* JobStepStatusCode.Succeeded */
