...
SELECT 122 /* JobEventCode.WorkerDead */, d.namespace_id, 70 /* JobActorCode.Worker */, CAST(d.id AS TEXT),
       NULL, NULL, NULL, NULL, d.id, NULL, NULL, NULL, NULL, 101 /* JobEventReasonCode.WorkerHeartbeatStale */, NULL
