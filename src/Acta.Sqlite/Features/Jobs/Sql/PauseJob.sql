...
UPDATE {{schema}}.runtimes
   SET status_code      = 30 /* JobStatusCode.Paused */,
       modified_at_utc  = {{now}},
       version          = version + 1
 WHERE job_id = @p_id
...
SELECT
    CASE
        ...
        WHEN s.from_status IN (30 /* JobStatusCode.Paused */, 20 /* JobStatusCode.Suspended */, 10 /* JobStatusCode.Ready */) THEN 1 /* JobControlAction.Applied */
