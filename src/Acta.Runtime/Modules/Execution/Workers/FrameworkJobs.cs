...
/// <c>AddOutboxRelay</c>, never through <see cref="JobsOptions.RegisterSystemJobs"/>. Registering a
...
{
    /// <summary>Auto-registered per namespace when <see cref="JobsOptions.RegisterSystemJobs"/> is on.</summary>
