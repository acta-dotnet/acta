...
/// <see cref="JobControlAction"/> and, on a successful attempt, the schedule's resulting state:
...
/// <see cref="JobControlAction.NotFound"/> and on <see cref="JobControlAction.Rejected"/>.
/// </remarks>
