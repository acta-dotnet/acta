...
internal sealed class Tenant : IEntity<int>
{
    ...
    [DbColumn("display_name", DbKind.UnicodeString, Size = CatalogMetadataLimits.TenantDisplayName)]
    public string? DisplayName { get; internal set; }

    /// <summary>
    /// Longer operator-readable notes about the tenant. Unicode-capable.
    /// </summary>
    [DbColumn("description", DbKind.UnicodeString, Size = CatalogMetadataLimits.TenantDescription)]
