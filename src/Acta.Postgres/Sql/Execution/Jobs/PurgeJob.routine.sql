...
BEGIN
    ...
    IF v_from_status NOT IN (100 /* JobStatusCode.Done */, 200 /* JobStatusCode.Failed */, 220 /* JobStatusCode.Cancelled */) THEN
    ...
    VALUES (
        75 /* JobEventCode.JobPurged */, now(), v_namespace_id,
        p_actor_code, p_actor_key,
        NULL, NULL, NULL,
        NULL, v_definition, v_tenant,
        NULL, v_from_status, NULL,
        NULL, NULL,
        p_reason_code, 'purged ' || v_job_ref::text || ' (' || v_job_name || ')');
