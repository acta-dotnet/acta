// Pure helpers for the tenant admin controls (suspend/resume/metadata edit): CAS payload building
...
// expectedVersion, only warn and reload. Shared by suspend/resume and the metadata editor.
