...
/// <see cref="ControlAction"/> so the dashboard maps it the same way as the job/schedule verbs
...
public sealed record DefinitionControlResult(ControlAction Action);
