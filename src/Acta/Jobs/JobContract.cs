...
/// job name. Passed to the contract <c>EnqueueAsync</c>/<c>ExecuteAndWaitAsync</c> overloads on
...
/// <c>ExecuteAndWaitAsync</c> and fire-and-forget <c>EnqueueAsync</c> (which drops the result).
/// </summary>
