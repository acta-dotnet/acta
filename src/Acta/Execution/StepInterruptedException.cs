...
/// </remarks>
/// <remarks>Creates the exception for the interrupted at-most-once step <paramref name="stepName"/>.</remarks>
public sealed class StepInterruptedException(string stepName)
    : Exception(
