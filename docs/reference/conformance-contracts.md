...
- **Store methods:**
  - `Acta.Services.Locks.ILockStore.TryAcquireAsync`
...
- **Store methods:**
  - `Acta.Services.Locks.ILockStore.ExtendAsync`
...
| --- | --- | --- | --- |
| `Alerts/AcknowledgeJobAlert` | yes | yes | yes |
| `Alerts/AlertsView` | yes | yes | yes |
| `Alerts/GetAlertableEvents` | yes | yes | yes |
| `Alerts/GetDeliverableAlerts` | yes | yes | yes |
| `Alerts/ListJobAlerts` | yes | yes | yes |
| `Alerts/RaiseJobAlert` | yes | yes | yes |
| `Alerts/ResolveJobAlertManual` | yes | yes | yes |
| `Alerts/ResolveJobAlerts` | yes | yes | yes |
| `Alerts/UpdateAlertDelivery` | yes | yes | yes |
| `Definitions/DefinitionsView` | yes | yes | yes |
| `Definitions/GetDefinitionContracts` | yes | yes | yes |
| `Definitions/GetJobDefinition` | yes | yes | yes |
| `Definitions/ListJobDefinitions` | yes | yes | yes |
| `Definitions/RegisterJobDefinitions` | yes | yes | yes |
| `Definitions/SetJobDefinitionOverrides` | yes | yes | yes |
| `Events/EventsView` | yes | yes | yes |
| `Events/ListJobEvents` | yes | yes | yes |
...
| `Jobs/JobsView` | yes | yes | yes |
| `Jobs/ListJobs` | yes | yes | yes |
| `Jobs/PauseJob` | yes | yes | yes |
| `Jobs/PurgeJob` | yes | yes | yes |
| `Jobs/ReprioritizeJob` | yes | yes | yes |
| `Jobs/RescheduleJob` | yes | yes | yes |
| `Jobs/ResetJobState` | yes | yes | yes |
| `Jobs/ResolveJobIdByDeduplicationKey` | yes | yes | yes |
...
| `Schedules/GetScheduleState` | yes | yes | yes |
| `Schedules/ListJobSchedules` | yes | yes | yes |
| `Schedules/PauseSchedule` | yes | yes | yes |
| `Schedules/RegisterScheduledJobs` | yes | yes | yes |
| `Schedules/ResumeSchedule` | yes | yes | yes |
...
| `Workers/MarkDeadWorkers` | yes | yes | yes |
| `Workers/StartWorker` | yes | yes | yes |
| `Workers/StopWorker` | yes | yes | yes |
| `Workers/WorkersView` | yes | yes | yes |
