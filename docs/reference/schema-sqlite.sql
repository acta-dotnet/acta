...
-- schema name 'main' throughout. Baseline stamp: baseline-ae203e66a1801dbadb6af7d799f352b6.
--
...
CREATE INDEX IF NOT EXISTS main.ix_runtimes_claim_ready ON runtimes (namespace_id, priority_code DESC, next_run_at_utc, job_id, status_code) WHERE status_code IN (10, 20);
...
CREATE INDEX IF NOT EXISTS main.ix_runtimes_worker_inflight ON runtimes (leased_by_worker_id, job_id) WHERE leased_by_worker_id IS NOT NULL AND status_code IN (40, 50);
...
VALUES (0, 'baseline-ae203e66a1801dbadb6af7d799f352b6', 'main')
...
INSERT INTO main.migrations (version, name, installed_schema)
VALUES (-1, 'objects-1.4-fa7744573f6ec85034943f82b43de4e6', 'main');
