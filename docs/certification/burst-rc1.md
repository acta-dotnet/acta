...
The plan's C6 gate, run 2026-08-22 on the near-final rc.1 commit `a38af45` - the tree after the
namespace-id widening and sequence-burn fix re-cut the baseline - with
...
**113-133 MB peak working set**, every invocation moving a full batch. The dashboard's alert list
...
```
  ACTA ALERT BURST CERTIFICATION  |  postgres  |  anvil_burst_b20260822_115437_41feaf  |  10,000 events
  ...
  [ok  ] drain-wall-clock             12,3s (budget 120s, includes the harness poll between invocations)
  ...
  [note] peak-working-set             113 MB peak over the drain, 131 MB allocated, 31 peak threads
...
```
  ACTA ALERT BURST CERTIFICATION  |  sqlserver  |  anvil_burst_b20260822_115530_dec10c  |  10,000 events
  ...
  [ok  ] incidents-materialized       alert rows=10,000 expected=10,000 (one open incident per failed job)
  [ok  ] projected-one-invocation     invocations that projected work=1 (a 10,000 backlog fits the 10,240-event bound)
  [ok  ] drain-wall-clock             12,7s (budget 120s, includes the harness poll between invocations)
  [ok  ] forward-progress             every invocation projected a full batch (min 10,000, max 10,000 events)
  [note] batches-per-invocation       min 40, max 40 of the 40 allowed
  [note] peak-working-set             114 MB peak over the drain, 242 MB allocated, 27 peak threads
  [ok  ] self-healed-zero-open        healed jobs=200 unresolved alerts left=0
  [ok  ] resolved-not-delivered       200 incident(s) were being re-sent before the heal; after it 0 were sent across two invocations that made 512 attempts
  [note] alerts-page-latency          p1=7ms p2=10ms p5=4ms p10=4ms p25=5ms p50=5ms over 100 page(s) of 100; slowest p3=12ms (page 1 includes the filter-wide count of 10,000)
  [ok  ] alerts-page-under-1s         slowest page 12ms at page 3
  [ok  ] retention-eligible           aged 200 open incident(s) past the cap (200 of them never delivered); 200 purged by one sys.retention pass, 0 left
  [ok  ] delivery-cap                 max 256 external attempts in one invocation (#1) of 7, cap 256
...
```
  ACTA ALERT BURST CERTIFICATION  |  sqlite  |  anvil_burst_b20260822_115602_8c65ba  |  10,000 events

  [note] backlog-seeded               10,000 failed jobs over 4 definitions in 15,1s
  [ok  ] backlog-unprojected          alerts=0 cursor=0 before the first invocation (both schedules parked through seeding)
  [ok  ] backlog-projected            projected=10,000 of 10,000 seeded events in 1 invocation(s)
  [ok  ] incidents-materialized       alert rows=10,000 expected=10,000 (one open incident per failed job)
  [ok  ] projected-one-invocation     invocations that projected work=1 (a 10,000 backlog fits the 10,240-event bound)
  ...
  [ok  ] forward-progress             every invocation projected a full batch (min 10,000, max 10,000 events)
  [note] batches-per-invocation       min 40, max 40 of the 40 allowed
  [note] peak-working-set             133 MB peak over the drain, 169 MB allocated, 19 peak threads
  [ok  ] self-healed-zero-open        healed jobs=200 unresolved alerts left=0
  [ok  ] resolved-not-delivered       200 incident(s) were being re-sent before the heal; after it 0 were sent across two invocations that made 512 attempts
  [note] alerts-page-latency          p1=10ms p2=10ms p5=8ms p10=8ms p25=7ms p50=5ms over 100 page(s) of 100; slowest p2=10ms (page 1 includes the filter-wide count of 10,000)
  [ok  ] alerts-page-under-1s         slowest page 10ms at page 2
  [ok  ] retention-eligible           aged 200 open incident(s) past the cap (200 of them never delivered); 200 purged by one sys.retention pass, 0 left
  [ok  ] delivery-cap                 max 256 external attempts in one invocation (#1) of 7, cap 256
...
```
  ACTA ALERT BURST CERTIFICATION  |  postgres  |  anvil_burst_b20260822_115629_ebc288  |  100,000 events

  [note] backlog-seeded               100,000 failed jobs over 4 definitions in 82,3s
  [ok  ] backlog-unprojected          alerts=0 cursor=0 before the first invocation (both schedules parked through seeding)
  ...
  [n/a ] drain-wall-clock             stated for the 10K backlog only; this run drained in 116,9s
  ...
  [note] peak-working-set             131 MB peak over the drain, 1288 MB allocated, 29 peak threads
  [ok  ] self-healed-zero-open        healed jobs=200 unresolved alerts left=0
  [ok  ] resolved-not-delivered       200 incident(s) were being re-sent before the heal; after it 0 were sent across two invocations that made 512 attempts
  [note] alerts-page-latency          p1=35ms p2=24ms p5=15ms p10=15ms p25=15ms p50=14ms over 200 page(s) of 100; slowest p1=35ms (page 1 includes the filter-wide count of 100,000)
  [ok  ] alerts-page-under-1s         slowest page 35ms at page 1
  [ok  ] retention-eligible           aged 200 open incident(s) past the cap (200 of them never delivered); 200 purged by one sys.retention pass, 0 left
...
```
  ACTA ALERT BURST CERTIFICATION  |  sqlserver  |  anvil_burst_b20260822_120016_3edcfb  |  100,000 events
  ...
  [ok  ] incidents-materialized       alert rows=100,000 expected=100,000 (one open incident per failed job)
  [n/a ] projected-one-invocation     a 100,000 backlog exceeds the 10,240-event invocation bound by design
  [n/a ] drain-wall-clock             stated for the 10K backlog only; this run drained in 127,1s
  [ok  ] forward-progress             every invocation projected a full batch (min 7,840, max 10,240 events)
  [note] batches-per-invocation       min 31, max 40 of the 40 allowed
  [note] peak-working-set             123 MB peak over the drain, 2359 MB allocated, 24 peak threads
  [ok  ] self-healed-zero-open        healed jobs=200 unresolved alerts left=0
  [ok  ] resolved-not-delivered       200 incident(s) were being re-sent before the heal; after it 0 were sent across two invocations that made 512 attempts
  [note] alerts-page-latency          p1=24ms p2=6ms p5=6ms p10=5ms p25=5ms p50=5ms over 200 page(s) of 100; slowest p1=24ms (page 1 includes the filter-wide count of 100,000)
  [ok  ] alerts-page-under-1s         slowest page 24ms at page 1
  [ok  ] retention-eligible           aged 200 open incident(s) past the cap (200 of them never delivered); 200 purged by one sys.retention pass, 0 left
  [ok  ] delivery-cap                 max 256 external attempts in one invocation (#1) of 16, cap 256
