    ...
    where TFixture : IConformanceFixture, new()
{
    ...
    public async Task Retirement_cancels_parked_jobs_with_definition_retired_reason()
    {
        ...
        Assert.Equal(ControlAction.Applied, (await jobs.PauseAsync(paused, null, null, ct: ct)).Action);
    ...
    public async Task Later_registration_does_not_resweep_an_already_retired_definition()
    {
        ...
        Assert.Equal(ControlAction.Applied, (await jobs.RestartAsync(job, null, null, ct: ct)).Action);
