...
public sealed class CommentStyleTests
{
    ...
    private static readonly HashSet<string> InternalRemarksAllowlist = Allow(
        ...
        "src/Acta/Features/Execution/StepOwnershipLostException.cs",
        "src/Acta/Features/Execution/StepRetrySignal.cs",
        "src/Acta/Features/Signals/SignalSuspendSignal.cs",
        "src/Acta/Features/Execution/SuspendSignal.cs",
        "src/Acta/Features/Alerts/AlertsJob.cs",
        "src/Acta/Features/Execution/RecoveryJob.cs",
        "src/Acta/Features/Retention/RetentionJob.cs",
        "src/Acta/Features/Execution/CompletionTypes.cs",
        "src/Acta/Features/Jobs/JobEnqueueRow.cs",
        "src/Acta/Features/Definitions/DefinitionRows.cs",
        "src/Acta/Features/Definitions/CatalogHash.cs",
        "src/Acta/Features/Workers/ClockSkewValidator.cs",
        "src/Acta/Features/Execution/JobBehaviorPipeline.cs",
        "src/Acta/Features/Definitions/JobDefinitionRegistration.cs",
        "src/Acta/Features/Execution/JobLogScope.cs",
        "src/Acta/Features/Execution/JobMetrics.cs",
        "src/Acta/Features/Definitions/JobTypeIndex.cs",
        "src/Acta/Features/Workers/WorkerContext.cs",
        "src/Acta/Features/Workers/WorkerHeartbeat.cs",
        "src/Acta/Features/Workers/WorkerRegistration.cs",
        "src/Acta/Features/Workers/WorkerRuntime.cs",
        "src/Acta/Features/Workers/WorkerRuntimeHost.cs",
        "src/Acta/Features/Workers/WorkerRuntimeInitializer.cs",
        "src/Acta/Features/Workers/WorkerWakeup.cs",
