...
/// <summary>The capabilities read exposes controlsEnabled, provider, version, and the confirmation header name.</summary>
public sealed class CapabilitiesEndpointTests
{
    ...
    private sealed record CapabilitiesDto(bool ControlsEnabled, string Version, string Provider, string ConfirmationHeader);
}
